#!/usr/bin/env python3
"""
Build and optionally imify the Eigenscribe theme CSS bundle.
"""
...
try:
    ...
    print(f"✅ Minified bundle created: {MINIFIED}")
except subprocess.CalledProcessError as exc:
    # csso ran but returned a non-zero exit code (syntax error in CSS)
    print(
        f"⚠️ Minifiaction failed (csso exit code {exc.returncocde})." 
        f"stderr:\n{exc.stderr}",
        file=sys.stderr,
    )
